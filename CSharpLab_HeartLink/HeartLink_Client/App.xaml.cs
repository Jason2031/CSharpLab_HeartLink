...
namespace HeartLink_Client
{
    ...
    public sealed partial class App : Application
    {
        ...
        protected override async void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            try
            {
                StaticObj.s = new Windows.Networking.Sockets.StreamSocket();
                await StaticObj.s.ConnectAsync(StaticObj.hostName, "30000");
                StaticObj.streamReader = new Windows.Storage.Streams.DataReader(StaticObj.s.InputStream);
                StaticObj.streamWriter = new Windows.Storage.Streams.DataWriter(StaticObj.s.OutputStream);
                connect = true;
            }
            catch (Exception ex)
            {
            ...
            if (!connect)
            {
                MessageDialog msg = new MessageDialog(exStr);
                await msg.ShowAsync();
            } 
        }
