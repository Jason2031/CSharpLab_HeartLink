    ...
    public sealed partial class Main : Page
    {
        ...
        protected async override void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (DataParser.GetPacketCommandCode(incommingContacters[0]) == Convert.ToInt32(CommandCode.ReturnContacters))
            {
                ...
                try
                {
                    ListView lv1 = FindChildControl<ListView>(ContactersHub, "ContactersDisplay") as ListView;
                    lv1.ItemsSource = Contacters;
                }
                catch { }
            }
            #endregion
            ...
            if (DataParser.GetPacketCommandCode(incommingMessageBox[0]) == Convert.ToInt32(CommandCode.ReturnMessageBox))
            {
                ...
                try
                {
                    ListView lv2 = FindChildControl<ListView>(MessageBoard, "MessageBoardDisplay") as ListView;
                    lv2.ItemsSource = MessageBox;
                }
                catch { }
            }
            #endregion
